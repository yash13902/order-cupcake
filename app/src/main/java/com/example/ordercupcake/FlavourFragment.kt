...
import com.example.ordercupcake.databinding.FragmentFlavourBinding
...
class FlavourFragment : Fragment() {
    ...
    fun goToNextScreen(){
        findNavController().navigate(FlavourFragmentDirections.actionFlavourFragmentToPickupFragment())
